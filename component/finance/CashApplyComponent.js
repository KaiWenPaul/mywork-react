    ...
    render(){
        return(
            <div style={{flex:1,display:'flex',flexDirection:'column'}}>
                ...
                {/*<TipComponent 
                style={{zIndex:1000}}
                visible={this.state.visible} msg={this.state.click_index===1?"确定通过?":(this.state.click_index===2?"确认不通过?":"确认打款了?")}
                              onClose={()=>{
                                this.setState({
                                    visible:false
                                })
                ...
                <div style={{display:'flex',alignItems:"center"}}>
                    ...
                    <CheckComponent title="已打款" checked={this.state.apply4}
                                    onClick={(checked)=>{
                                if(checked==='1'){
