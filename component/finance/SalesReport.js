...
class SalesReport extends  Widget.BaseComponent{
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            start_time:"",
            end_time:"",
            orderSourceWays:[{id:"goods",name:"商品购买"},{id:"recharge",name:"现价充值"},{id:"payForTrust",name:"信用余额还款"}],
            orderBeans:[],
            allMerchantsBeans:[],
            selectBean:{},
            total:0,
    ...
    doSuccess(index,data){
        switch (index){
            case 1:
                ...
                break;
            case 2:
                let orderBeans= data.data.orderGoodsBeans;
                for(let orderBean of orderBeans) {
                    if (orderBean.is_prepare_order === true && orderBean.order_state === "wait_receive") {
    ...
    render(){
        return(
            <div style={{flex:1,display:'flex',flexDirection:'column'}}>
                <Widget.Toolbar title="销售商品报表" history={this.props.history}></Widget.Toolbar>
