    ...
    render(){
        return(
            <div style={{display:'flex',height:'100%',width:'100%',flex:1,flexDirection:'column'}}>
                <div style={{background:'#000000',height:40,display:'flex',alignItems:'center'}} key="main_1">
                    ...
                    <div style={{display:'flex',justifyContent:'flex-end',alignItems:'center',flex:1}}
                        ...
                        <div style={{height:40,}}>
                            ...
                            <div style={{display:this.state.visible?'flex':"none",flexDirection:'column'
                                ...
                                borderWidth:1,borderColor:'#efefef',borderStyle:'solid',zIndex:999}}>
                                ...
                                <div style={{background:'#ffffff',display:'flex',width:100,height:30,
                                                ...
                                                onClick={()=>{
                                                    ...
                                                    window.location.href= htmlurl+"back_index.html";
                                                }}>
                ...
                <div style={{display:'flex',flex:1}}  key="main_2">
                    <ListView
                        ...
                        return(
                            <div key={"menu"+rowID}>
                                <div style={{background:'#cdcdcd',height:1,flex:1}} key={"menu"+rowID+"1"}></div>
                                <div style={{height:38,width:160,background:'#c8c8c8',display:'flex',alignItems:'center'}} key={"menu"+rowID+"2"}
                                    onClick={()=>{
                                    ...
                                    <p1 style={{fontSize:13,marginLeft:20}}  key={"menu"+rowID+"2_1"}>{this.state.moudleBeans[rowID].moudle_name}</p1>
                                    <div style={{display:'flex',flex:1,justifyContent:'flex-end'}} key={"menu"+rowID+"2_2"}>
                                        <img src={this.state.itemCurIndex===rowID?"./images/xia.png":'./images/shang.png'}
                                        style={{width:12,height:8,marginRight:20}}/>
                                    </div>
                                </div>
                                <div style={{background:'#cdcdcd',height:1,flex:1}} key={"menu"+rowID+"3"}></div>
                                <ListView key={"menu"+rowID+"4"}
                                    ...
                                    renderRow={(index)=>{
                                        return(
                                            <Link to={this.state.moudleBeans[rowID].menuBeans[index].moudle_url}
                                                  ...
                                                  key={this.state.moudleBeans[rowID].menuBeans[index].moudle_url}
                                                >
