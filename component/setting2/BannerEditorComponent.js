        ...
        if(!this.state.bannerBean.banner_id){
            this.getDataByPost(1,homeurl+"bannerController.api?insertBanner",
                {banner_desc:this.state.banner_desc,banner_title:this.state.banner_title,
                    ...
                    goods_uuid:this.state.selectClassBean.class_uuid,
                    goods_class_name:this.state.selectClassBean.class_name,
    ...
    doSuccess(index,data){
        switch (index){
            ...
            case 4:
                ...
                if(data.length>0) {
                    var d=data.filter(function(item){
                        return item["class_uuid"]+""===this.state.bannerBean.goods_uuid+"";
                    }.bind(this));
