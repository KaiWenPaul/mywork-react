...
// var GoodsEditorComponent=require("./../goods2/GoodsEditorComponent");
var integralGoodsEditorComponent=require("./integralGoodsEditorComponent");
var GoodsDetailPictureComponent=require("./../goods2/GoodsDetailPictureComponent");
var GoodsDetailEditorComponent=require("./../goods2/GoodsDetailEditorComponent");

class integralGoodsDetailComponent extends  Widget.BaseComponent{
    // 构造
    constructor(props) {
        super(props);
        // 初始状态
    ...
    renderBase(){
        return(
            <integralGoodsEditorComponent
                updateMoudle={this.updateMoudle.bind(this)}
                history={this.props.history} goodsBean={this.state.goodsBean}></integralGoodsEditorComponent>
        )
    }
...
module.exports=integralGoodsDetailComponent;