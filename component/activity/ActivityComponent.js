    ...
    render() {
        return (
            <div style={{flex: 1, display: 'flex', flexDirection: 'column'}}>
                <Toolbar title="活动管理" history={this.props.history}></Toolbar>
                ...
                <ListViewComponent
                    data={[
                        ...
                        {name: "活动状态", flex: 1, key: "activity_state", type: "bool",show1:"已开启",show0:"已关闭"},
                        {name: "是否加入热门活动榜", flex: 1, key: "is_hot", type: "bool",show1:"是",show0:"否"},
