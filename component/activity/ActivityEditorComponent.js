    ...
    constructor(props) {
        ...
        this.state = {
            ...
            typeBeans: [{name: "满送活动", id: 'give'},
                ...
                {name: '半价活动', id: 'half'},
                {name: '减免活动', id: 'exempt'},
                {name: '无优惠的活动',id:'nothing'},
                {name: "数量折扣", id: 'count_discount'}],
            stateBeans: [{name: "关闭", id: '0'}, {name: "开启", id: '1'}],
            hotBeans: [{name: "不加入", id: '0'}, {name: "加入", id: '1'}],
        };
    }
        ...
        if(this.state.activity_id){
            this.getDataByPost(2,homeurl+"activityController.api?updateActivityDetail",
                {activity_id:this.state.activityBean.activity_id,
                    ...
                    is_hot:this.state.activityBean.is_hot,
                    ...
                    discount_need_count:this.state.activityBean.countDiscountBean.discount_need_count,
                    discount_rate:this.state.activityBean.countDiscountBean.discount_rate,
                    discount_id:this.state.activityBean.countDiscountBean.discount_id,
    ...
    render(){
        return(
            <div>
                ...
                <div style={{display:this.state.activityBean.activity_type==="count_discount"?'flex':"none",alignItems:'center',marginTop:20}}>
                    <EditorComponent
                        title="满多少数量"
                        value={this.state.activityBean.countDiscountBean.discount_need_count}
                        onChange={(value)=>{
                            this.state.activityBean.countDiscountBean.discount_need_count=value;
                            this.setState({
                                activityBean:this.state.activityBean
                            })
                        }}/>
                    <EditorComponent
                        title="统一折扣"
                        value={this.state.activityBean.countDiscountBean.discount_rate}
                        onChange={(value)=>{
                            this.state.activityBean.countDiscountBean.discount_rate=value;
                            this.setState({
                                activityBean:this.state.activityBean
                            })
                        }}/>
                ...
                <Widget.SelectV2
                    title="热门活动榜"
                    show_value="name"
                    init_value={this.state.activityBean.is_hot}
                    select_value="id"
                    dataSource={this.state.hotBeans}
                    onChange={(rowID)=>{
                        this.state.activityBean.is_hot=this.state.stateBeans[rowID].id
                        this.setState({
                            activityBean:this.state.activityBean,
                        })
                    }}/>
