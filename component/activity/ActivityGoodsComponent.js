...
class ActivityGoodsComponent extends  Widget.BaseComponent{
    ...
    componentDidMount() {
        ...
        this.getDataByPost(10,homeurl+"goodsController.api?getAllBrands",{})
    }
    ...
    insertGoods(){
        if(this.isNull(this.state.in_goods_id)){
            this.showTip("请先选择商品");
            return;
        }
        ...
        this.getDataByPost(4,homeurl+"activityController.api?insertActivityGoods",
            {activity_id:this.state.activity_id,
                goods_id:this.state.in_goods_id,
    ...
    deleteGoods(){
        this.getDataByPost(9,homeurl+"activityController.api?deleteActivityGoods",
    ...
    render(){
        return(
            <div>
                ...
                <Widget.Tip visible={this.state.allVisible} msg="确定全部移除?"
                            onClose={()=>{
                                this.setState({
                                    allVisible:false
                                })
               ...
               {/*
                    ...
                    <p1 style={{fontSize:13,marginLeft:20,marginRight:20}}>品牌名</p1>
                    <Widget.SearchBar
                        item_name="brand_name"
                        dataSource={this.state.allBrands}
                        name={this.state.brands_name}
                        onPress={(data,value)=>{
                            this.setState({
                                selectBrandBeans:data,
                                brands_name:value,
                            })
                            console.log(123)
                        }}/>
                ...
                */}
                ...
                <div style={{display:'flex',alignItems:'center',marginTop:20}}>
                 ...
                 <PutExcelComponent visible={this.state.allVisible1} activity_id={this.state.activity_id}
                                    msg={this.state.putExcel===1?'导入活动商品':'批量更新活动商品'}
                            onClose={()=>{
                                this.setState({
                                    allVisible1:false
                                })
                ...
                <Widget.ListViewComponent
                    ...
                    operationData={[{title:"编辑",type:1},{title:"移除",type:2}]}
