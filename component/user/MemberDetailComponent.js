...
class BaseDetailComponent extends BaseComponent{
    ...
    updateMemberDetail(){
        this.getDataByPost(2,homeurl+"memberController.api?updateMemberDetail",
                                            ...
                                            referral_code:this.state.memberBean.referral_code,
        ...
        return(
            <div>
                ...
                <div style={{display:'flex',marginTop:20}}>
                    ...
                    <EditorComponent
                        title="推荐码"
                        value={this.state.memberBean.referral_code}
                        onChange={(value)=>{
                            this.state.memberBean.referral_code=value;
                            this.setState({
                                memberBean:this.state.memberBean
                            })
                        }}>
                ...
                <div style={{display:'flex',marginTop:20}}>
                    <TextComponent title="用户昵称"
                                   value={this.state.memberBean.nick_name}>

                    </TextComponent>
                    <TextComponent title="手机号"
                                   value={this.state.memberBean.phone}>

                    </TextComponent>
                </div>
                <div style={{display:'flex',marginTop:20}}>
                    <TextComponent title="信用额度"
                                   value={this.state.memberBean.trust_line}>
                    </TextComponent>
                    <TextComponent title="信用余额"
                                   value={this.state.memberBean.trust_balance}>
                    </TextComponent>
                    <TextComponent title="本期还款日"
                                   value={this.state.memberBean.trust_paytime}>
                    </TextComponent>
                </div>
                <div style={{display:'flex',marginTop:20}}>
                    <TextComponent title="下期应还款"
                                   value={this.state.memberBean.trust_payAmount_next}>
                    </TextComponent>
                    <TextComponent title="本期还款额"
                                   value={this.state.memberBean.trust_payAmount_current}>
                    </TextComponent>
                    <TextComponent title="已欠款金额"
                                   value={this.state.memberBean.trust_payAmount_indebt}>
                    </TextComponent>
                </div>
                <div style={{display:'flex',marginTop:20}}>
                    <TextComponent title="用户积分"
                                   value={this.state.memberBean.integral}>

                    </TextComponent>
                    <TextComponent title="用户余额"
                                   value={this.state.memberBean.balance}>

                    </TextComponent>
                </div>
                    <div style={{display:'flex',marginTop:20}}>
                    <TextComponent title="位置"
                                   value={this.state.memberBean.position}>

                    </TextComponent>
                    <TextComponent title="兴趣爱好"
                                   value={this.state.memberBean.hobby}>

                    </TextComponent>
                    <TextComponent title="注册时间"
                ...
                <div style={{display:'flex',height:50,alignItems:'center',marginTop:20}}>
                    ...
                    <TextComponent
                        title="性别"
                        value={this.state.memberBean.sex==='m'?'男':'女'}>
                    </TextComponent>
                    {/*<div style={styles.tabTitle}>
