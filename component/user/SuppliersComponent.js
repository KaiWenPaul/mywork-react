    ...
    componentDidMount() {
        this.setState({
            baseData:[
                ...
                {name:"入驻供应商名称",flex:2,key:'merchants_name'},
    ...
    render(){
        return(
            <div style={{background:'#ffffff',flex:1,height:'100%'}}>
                ...
                <Toolbar title="入驻供应商管理" history={this.props.history}></Toolbar>
                ...
                <ListViewComponent
                    ...
                    renderAdd={()=>{
                        return(
                            <Link to={"/user_suppliers_editor/"+encodeURIComponent(JSON.stringify({}))}
