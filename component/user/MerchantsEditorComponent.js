...
class MerchantsEditorComponent extends Widget.BaseComponent {
    ...
    render() {
        return (
            <div>
                <Widget.Toolbar title="店铺详情管理" history={this.props.history}/>
...
class MerchantsBaseDetailComponent extends Widget.BaseComponent {
    ...
    getMerchantsDetail() {
        this.getDataByPost(4, homeurl + "merchantsController.api?getOneMerchantsDetail"
            ...
            this.getDataByPost(1, homeurl + "merchantsController.api?insertMerchantDetail",
                {
                    ...
                    custom_id:this.state.merchantsBean.custom_id});
        } else {
    ...
    render() {
        let view=[];
        console.log(this.state.merchantsBean);
        //if(this.state.merchantsBean.merchants_id){
        ...
        return (
            <div>
                ...
                <div style={{display:'flex',alignItems:'center',marginTop:20}}>
                    ...
                    <Widget.Editor
                        title="客服ID"
                        value={this.state.merchantsBean.custom_id}
                        onChange={(value)=>{
                            this.state.merchantsBean.custom_id=value;
                            this.setState({
                                merchantsBean:this.state.merchantsBean,
                            })
                        }}/>
        ...
        return(
            <div>
                ...
                <Widget.Tip
                    ...
                    msg={ this.state.click_index===1?"确认修改":"确认删除" }
                    onClose={()=>{
                        this.setState({
                            visible:false
                        })
