    ...
    getParameters(){
        this.setState({
            baseData:[
                ...
                {name:"规格名/规格值",flex:1,key:'parameter_name'},
                {name:"规格溢价PC现价",flex:1,key:"parameter_pc_price"},
                {name:"规格溢价现价",flex:1,key:"parameter_price"},
                {name:"规格溢价原价",flex:1,key:"parameter_origin_price"},
                                ...
                                <div style={{display:'flex',flex:1,flexDirection:'row',alignItems:'center',justifyContent:'center'}}>
                                    <Link to={'/goods_parameter_editor/'+
                                            encodeURIComponent(JSON.stringify({goods_id:this.props.goods_id,parent_id:this.state.parameterBeans[rowID].parameter_id,parameter_type:'2'}))}
                                                style={{textDecoration:'none'}}>
                                        <p1 style={{fontSize:13,color:'blue'}}>[添加规格值]</p1>
                                    </Link>
                                </div>
                                <div style={{display:'flex',flex:1,flexDirection:'row',alignItems:'center',justifyContent:'center'}}>
                                    <Link to={'/goods_parameter_editor/'+
