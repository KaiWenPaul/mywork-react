    ...
    componentDidMount() {
        this.setState({
            baseData:[
                ...
                {name:"销售人员",flex:1,key:'merchants_name'},
    ...
    render(){
        return(
            <div style={{flex:1,display:'flex',flexDirection:'column'}}>
                ...
                <div style={{display:'flex',alignItems:'center'}}>
                    <div style={styles.tabTitle}>
                        <p1 style={styles.font}>订单类型</p1>
                    </div>
                    <Widget.Check title="商品购买订单" checked={this.state.source1}
                                  onClick={(checked)=>{
                                      if(checked==='1'){
                                          this.setState({
                                              source4:1,
                    ...
                    <Widget.Check title="余额充值订单" checked={this.state.source2}
                                  onClick={(checked)=>{
                                      if(checked==='1'){
                                          this.setState({
                                              source4:2,
                                      ...
                                      this.setState({
                                          order_source_way:"recharge",
                                          source1:0,
                                          source3:0
                                      })
                                  }}/>
                    <Widget.Check title="信用还款订单" checked={this.state.source3}
                                  onClick={(checked)=>{
                                      if(checked==='1'){
                                          this.setState({
                                              source4:3,
