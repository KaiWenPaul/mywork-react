...
class SearchBar extends Component {
    ...
    render() {
        return (
            <div style={{
                display: !this.props.visible || this.props.visible === 'true' ? "" : "none",
                background: '#ffffff',
                width: 200,
                height: 30,
                               ...
                               if (e.target.value === '') {
                                   ...
                                   this.setState({
                                       ...
                                       data: this.props.dataSource.filter(function (item) {
                                           return item[this.props.item_name].toLowerCase().indexOf(e.target.value.toLowerCase()) >= 0;
                                       }.bind(this))
                                   })
                               }
                                ...
                                <div style={{display: 'flex', flex: 1, flexDirection: 'column',}}
                                    ...
                                    <div style={{display: 'flex', alignItems: 'center', marginTop: 4, marginBottom: 4}}>
                                        <p1 style={{
                                            fontSize: 15,
                                            marginLeft: 10
                                        }}>{this.state.data[rowID][this.props.item_name]}</p1>
                                    </div>
