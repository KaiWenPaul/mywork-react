                    ...
                    if(this.props.data[i].key==='-2') {//选择按钮
                        headerView.push(
                            <div style={{flex:this.props.data[i].flex,display:'flex',
                             ...
                             key={"checkbox_"+this.props.data[i].key}>
                                <input type="checkbox"
                        ...
                        if(this.props.data[j].key==='-2') {//选择按钮
                            viewTemp.push(
                                <div style={{flex:this.props.data[j].flex,display:'flex',
                                     ...
                                     borderBottomWidth:1,borderRightWidth:1,
                                     borderBottomColor:'#c8c8c8',borderRightColor:'#c8c8c8',
                                     borderBottomStyle:'solid',borderRightStyle:'solid',padding:10,}} key={"listView_checkbox_"+this.props.dataSource[i]}>
                                ...
                                for(let h=0;h<this.props.operationData.length;h++){
                                    opertionView.push(
                                        ...
                                        ,marginLeft:10,alignItems:'center',justifyContent:'center'}}
                                             ...
                                             key={this.props.dataSource[i][this.props.data[0].key]+"_operation_"+h}>
                            ...
                            viewTemp.push(
                                <div style={{flex:this.props.data[j].flex,display:'flex',
                                     ...
                                     borderBottomColor:'#c8c8c8',borderRightColor:'#c8c8c8',
                                     borderBottomStyle:'solid',borderRightStyle:'solid',padding:10}}
                                     key={this.props.dataSource[i][this.props.data[0].key]+"_operation"}>
                            ...
                            if(this.props.data[j].type==='img'){//图片展示
                                viewTemp.push(
                                    <div style={{flex:this.props.data[j].flex,display:'flex',
                                        ...
                                        borderBottomColor:'#c8c8c8',borderRightColor:'#c8c8c8',
                                        borderBottomStyle:'solid',borderRightStyle:'solid',padding:10,}}
                                         key={this.props.dataSource[i][this.props.data[0].key]+"_"+j}>
                            ...
                            }else if(this.props.data[j].type==='bool'){//图片展示
                                viewTemp.push(
                                    <div style={{flex:this.props.data[j].flex,display:'flex',
                                        flexWrap:'wrap',flexDirection: 'row',
                                        alignItems:'center',justifyContent:'center',
                                        ...
                                        borderBottomStyle:'solid',borderRightStyle:'solid',padding:10,}}
                                         key={this.props.dataSource[i][this.props.data[0].key]+"_"+j}>
                                        <p1 style={styles.tabP1}>{title==="1"?this.props.data[j].show1:this.props.data[j].show0}</p1>
                                    </div>
                                )
                            }else{
                                if(title==='待发货'){
        ...
        return(
            <div>
                ...
                <div style={{flex: 1,
                     ...
                     key="listView2">
                    <div style={{flex:1,display:'flex'}} key="listView2_head">
                        {headerView}
                    </div>
                    {view}
                </div>
