        ...
        if(this.props.dataSource){
            ...
            for(let i=0;i<this.props.dataSource.length;i++){
                ...
                view.push(<div id={i} data-nid={save_value} style={{flex:this.props.flex,display:'flex',flexWrap:'wrap',flexDirection: 'row',
                                     ...
                                     borderBottomStyle:'solid',borderRightStyle:'solid',borderLeftStyle:'solid',padding:10,}}
        ...
        return(
            <div style={{display:'flex',flexDirection:'column',alignItems:"left",marginTop:20,marginLeft:this.props.marginLeft?this.props.marginLeft:20}}>
                <div styles ={{flex:this.props.flex,display:'flex',
                    ...
                    <div style={{width:this.props.width?this.props.width:(this.props.title?"99.67%":0),display:'flex',justifyContent:'flex-end',border:'1px solid #c8c8c8',textAlign:'center'}}>
                    ...
                    <div styles = {{flex:this.props.flex,display:'flex'}}>
                        <div style= {{borderTopWidth:1,borderLeftWidth:1,borderBottomWidth:1,borderRightWidth:1,
                            ...
                            {view}
                            <div style={{borderLeft:'1px solid #c8c8c8',borderRight:'1px solid #c8c8c8',borderBottom:'1px solid #c8c8c8',}}>
                ...
                <div id={this.props.checklist_id} style={{marginTop:10,marginBottom:30}}>
                    <p1 style={{color:'#4DA0F3'}}>{this.props.sectitle}</p1>
                </div>
            </div>
        )
    }
