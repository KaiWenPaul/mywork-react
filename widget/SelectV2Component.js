    ...
    render(){
        ...
        for(let i=0;i<this.props.dataSource.length;i++){
            if(this.props.init_value+""===this.props.dataSource[i][this.props.select_value]+""){
                view.push(<option selected="selected" key={"option_"+i}>{this.props.dataSource[i][this.props.show_value]}</option>);
            }else{
                view.push(<option key={"option_"+i}>{this.props.dataSource[i][this.props.show_value]}</option>);
            }
        }
